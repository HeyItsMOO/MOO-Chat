    ...
    <main>
      ...
      <section className="container-x pb-8">
        <div className="grid gap-6 md:grid-cols-3">
          {PLATFORMS.map((p) => (
            <div key={p.title} className="flex flex-col rounded-2xl border border-slate-100 p-7 shadow-sm">
      ...
      <section className="container-x pb-12">
        <div className="rounded-2xl bg-slate-50 p-8 text-center">
          ...
          <div className="mt-5 flex flex-wrap justify-center gap-3">
            <Link href="/docs" className="rounded-xl bg-brand-600 px-5 py-2.5 font-semibold text-white hover:bg-brand-700">
              Read the docs
            </Link>
            <Link href="/contact" className="rounded-xl border border-slate-200 px-5 py-2.5 font-semibold text-ink hover:bg-white">
              Ask a question
            </Link>
          </div>
        </div>
